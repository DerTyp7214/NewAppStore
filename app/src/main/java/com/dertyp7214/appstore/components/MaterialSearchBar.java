...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray array =
                getContext().obtainStyledAttributes(attrs, R.styleable.MaterialSearchBar);
        ...
        menuDividerEnabled =
                array.getBoolean(R.styleable.MaterialSearchBar_mt_menuDividerEnabled, false);
        ...
        menuIconRes = array.getResourceId(R.styleable.MaterialSearchBar_mt_menuIconDrawable,
        ...
        speechIconRes = array.getResourceId(R.styleable.MaterialSearchBar_mt_speechIconDrawable,
        ...
        navIconTintEnabled =
                array.getBoolean(R.styleable.MaterialSearchBar_mt_navIconUseTint, true);
        menuIconTintEnabled =
        ...
        leftTextSelectorTint = array.getColor(R.styleable.MaterialSearchBar_mt_leftTextSelectorTint,
                ContextCompat.getColor(getContext(), R.color.leftTextSelectorColor));
        middleTextSelectorTint =
                array.getColor(R.styleable.MaterialSearchBar_mt_middleTextSelectorTint,
                        ContextCompat.getColor(getContext(), R.color.middleTextSelectorColor));
        rightTextSelectorTint =
                array.getColor(R.styleable.MaterialSearchBar_mt_rightTextSelectorTint,
                        ContextCompat.getColor(getContext(), R.color.rightTextSelectorColor));
        leftTextSelectorRes =
                array.getResourceId(R.styleable.MaterialSearchBar_mt_leftTextSelectorDrawable,
                        R.drawable.text_select_handle_left_mtrl_alpha_mtrlsearch);
        middleTextSelectorRes =
                array.getResourceId(R.styleable.MaterialSearchBar_mt_middleTextSelectorDrawable,
                        R.drawable.text_select_handle_middle_mtrl_alpha_mtrlsearch);
        rightTextSelectorRes =
                array.getResourceId(R.styleable.MaterialSearchBar_mt_rightTextSelectorDrawable,
                        R.drawable.text_select_handle_right_mtrl_alpha_mtrlsearch);
        textSelectorTintEnabled =
                array.getBoolean(R.styleable.MaterialSearchBar_mt_handlesTintEnabled, true);
    ...
    private void setupRoundedSearchBarEnabled() {
        if (roundedSearchBarEnabled && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            searchBarCardView.setRadius(
                    dp != NaN ? dp : getResources().getDimension(R.dimen.corner_radius_rounded));
        } else {
            searchBarCardView.setRadius(getResources().getDimension(R.dimen.corner_radius_default));
        }
    }

    public void setupRoundedSearchBarEnabled(int dp) {
        if (roundedSearchBarEnabled && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            this.dp = dp;
            searchBarCardView.setRadius(dp);
        } else {
            searchBarCardView.setRadius(getResources().getDimension(R.dimen.corner_radius_default));
        }
    }
    ...
    private void setupSearchEditText() {
        try {
            EditTextStyleHelper
                    .applyChanges(this.searchEdit, this.textCursorColor, this.leftTextSelectorTint,
                            this.rightTextSelectorTint, this.middleTextSelectorTint,
                            this.leftTextSelectorRes, this.rightTextSelectorRes,
                            this.middleTextSelectorRes, this.textSelectorTintEnabled);
    ...
    private void setupIconRippleStyle() {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            ...
            if (borderlessRippleEnabled && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getContext().getTheme()
                        .resolveAttribute(android.R.attr.selectableItemBackgroundBorderless,
                                rippleStyle, true);
            } else {
                getContext().getTheme()
                        .resolveAttribute(android.R.attr.selectableItemBackground, rippleStyle,
                                true);
            }
