...
public class FragmentAbout extends MaterialAboutFragment {
    ...
    protected MaterialAboutList getMaterialAboutList(Context context) {
        ...
        notices.addNotice(new Notice("Android Support", "https://android.googlesource.com", "The Android Open Source Project", new ApacheSoftwareLicense20()));
        notices.addNotice(new Notice("RootBeer", "https://github.com/scottyab/rootbeer", "Scott Alexander-Bown, Mat Rollings", new ApacheSoftwareLicense20()));
        notices.addNotice(new Notice("RoundedImageView", "https://github.com/vinc3m1/RoundedImageView", "Vincent Mi", new ApacheSoftwareLicense20()));
        ...
        notices.addNotice(new Notice("Android System Bar Tint", "https://github.com/jgilfelt/SystemBarTint", "readyState Software Limited", new ApacheSoftwareLicense20()));
        notices.addNotice(new Notice("PayPal Android SDK", "https://github.com/paypal/PayPal-Android-SDK", "PayPal Holdings, Inc.", new BSD2ClauseLicense()));
        ...
        notices.addNotice(new Notice("Lottie for Android", "https://github.com/airbnb/lottie-android", "Airbnb, Inc.", new ApacheSoftwareLicense20()));
        ...
        notices.addNotice(new Notice("Material SearchBar Android Material Design Search Bar for Android", "https://github.com/mancj/MaterialSearchBar", "mancj", new MITLicense()));
        notices.addNotice(new Notice("CircularImageView", "https://github.com/lopspower/CircularImageView", "LOPEZ Mikhael", new ApacheSoftwareLicense20()));
