...
import com.dertyp7214.appstore.adapter.SearchAdapter.ViewHolder
import com.dertyp7214.appstore.items.SearchItem
import com.dertyp7214.appstore.screens.AppScreen

class SearchAdapter(private val context: Activity, private val appItemList: List<SearchItem>) : RecyclerView.Adapter<ViewHolder>() {
